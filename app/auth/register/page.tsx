    ...
    <div className="min-h-screen bg-sand-50 flex items-center justify-center py-12 px-4">
      ...
      >
        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold text-charcoal-900">Create Account</h1>
          <p className="text-charcoal-500 mt-2">Join the Stylepop family</p>
        </div>
        ...
        <p className="text-center mt-6 text-charcoal-500">
          ...
          <Link href="/auth/login" className="text-charcoal-900 font-medium hover:underline">
            Sign in
          </Link>
        </p>
      </motion.div>
